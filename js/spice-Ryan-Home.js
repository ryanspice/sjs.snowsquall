	...
	create:function(){
		...
		temp = Object.create({
			...
			constructor:{
				...
				toggleWidescreen:{writable:false, configurable:false, enumerable:false, value:function(){ this.client.update.fullscale = !this.client.update.fullscale; return this.client.update.fullscale; } },
