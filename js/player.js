...
//		this.app.getCurrent().game.mapscale = (7-this.speed);
	...
	//	if (this.app.getCurrent().game.mapscale>0.75)
				this.app.getCurrent().game.mapscale =this.aird/2;//,this.speed-=0.0005;
	//
	//	if( (adjust>0.012)||
	//	   (adjust<-0.012))
	...
	////			this.app.getCurrent().game.mapscale +=0.0011;
		this.app.getCurrent().game.mapscale = this.app.client.Math.Clamp(this.app.getCurrent().game.mapscale,0.9,2);
